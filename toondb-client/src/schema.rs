...
use crate::connection::{ToonConnection, to_field_type};
use crate::error::{ClientError, Result};

use toondb_core::toon::{ToonSchema, ToonType};
...
impl SchemaBuilder {
    ...
    /// Add a field
    pub fn field(mut self, name: &str, field_type: ToonType) -> FieldConfig {
    ...
    /// Build the ToonSchema
    pub fn build(self) -> ToonSchema {
        let mut schema = ToonSchema::new(&self.name);
...
impl FieldConfig {
    ...
    pub fn field(self, name: &str, field_type: ToonType) -> FieldConfig {
...
impl ToonConnection {
    ...
    pub fn create_table(&self, schema: ToonSchema) -> Result<CreateTableResult> {
