...
//! FFI bindings for ToonDB Vector Index (HNSW)
//!
...
//! set the environment variable `TOONDB_BATCH_SAFE_MODE=1` to route all batch
...
/// 
/// When `TOONDB_BATCH_SAFE_MODE=1` is set, batch inserts will use
...
/// # Safe Mode
/// 
/// If environment variable `TOONDB_BATCH_SAFE_MODE=1` is set, this function
...
// - toondb_profiling_enable()
// - toondb_profiling_disable()
// - toondb_profiling_dump()
// - toondb_profiling_record()
//
