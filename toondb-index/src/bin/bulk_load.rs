...
//! toondb-bulk-load --input embeddings.bin --output index.hnsw --dimension 768
//! 
//! # Build from NumPy .npy file
//! toondb-bulk-load --input embeddings.npy --output index.hnsw --dimension 768 --format npy
//! 
//! # Custom HNSW parameters
//! toondb-bulk-load --input data.bin --output index.hnsw --dimension 768 \
...
fn print_usage() {
    eprintln!(r#"
ToonDB Bulk Load - High-performance HNSW index builder
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    eprintln!("╔══════════════════════════════════════════════════════════════╗");
    eprintln!("║  ToonDB Bulk Load - High-Performance HNSW Builder            ║");
    eprintln!("╚══════════════════════════════════════════════════════════════╝");
    eprintln!();
