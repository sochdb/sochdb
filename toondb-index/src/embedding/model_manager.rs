...
impl ModelManager {
    ...
    fn get_model_dir() -> Result<PathBuf, ModelError> {
        // Linux: ~/.local/share/toondb/models/
        // macOS: ~/Library/Application Support/toondb/models/
        // Windows: %APPDATA%\toondb\models\
        let data_dir = dirs::data_dir().unwrap_or_else(|| PathBuf::from("."));

        Ok(data_dir.join("toondb").join("models"))
    }
...
mod tests {
    ...
    fn test_model_dir() {
        ...
        assert!(dir.to_string_lossy().contains("toondb"));
