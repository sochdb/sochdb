...
// Novel data structures
// LearnedSparseIndex is now in toondb-core to avoid cyclic dependencies
pub use toondb_core::learned_index;
...
pub mod profiling; // End-to-end profiling (TOONDB_PROFILING=1)
...
// Re-exports for novel structures (LearnedSparseIndex comes from toondb-core)
