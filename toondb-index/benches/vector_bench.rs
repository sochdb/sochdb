...
//!
//! Run with: cargo bench -p toondb-index --bench vector_bench

use ndarray::Array1;
use std::hint::black_box;
use std::time::{Duration, Instant};
use toondb_index::vector::{DistanceMetric, VectorIndex};
use toondb_index::vector_quantized::{Precision, QuantizedVector};
use toondb_index::vector_simd;
...
fn main() {
    println!("ToonDB Vector Index - CoreNN-Inspired Optimizations Benchmark");
    println!("================================================================");
