...
//! Plugin Architecture
//!
//! ToonDB uses a plugin architecture to keep the kernel minimal while
...
//!
//! ```ignore
//! // In a separate crate: toondb-prometheus-plugin
...
///
/// - `toondb-prometheus`: Prometheus metrics
/// - `toondb-datadog`: DataDog integration  
/// - `toondb-opentelemetry`: OpenTelemetry support
/// - `toondb-logging-json`: JSON structured logging
/// - `toondb-logging-logfmt`: logfmt style logging
